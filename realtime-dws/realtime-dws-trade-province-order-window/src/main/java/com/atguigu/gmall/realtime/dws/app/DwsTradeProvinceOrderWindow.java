...
//        stream.print();
        ...
        // 3.添加水位线
        SingleOutputStreamOperator<JSONObject> withWaterMark = jsonObjStream.assignTimestampsAndWatermarks(WatermarkStrategy.<JSONObject>forBoundedOutOfOrderness(Duration.ofSeconds(5L)).withTimestampAssigner(
